...
public class RandomNumberSortUtilTest {
	...
	public void generateRandomNumbers() {
		...
		Assert.assertTrue(5 == generatedRandomNumbers.length);
	}
	...
	public void mapToModel() {
		...
		Assert.assertEquals(sortedNumbersString, model.getSortedNumbers());
		Assert.assertEquals(randomNumbersString, model.getUnsortedNumbers());
		Assert.assertTrue(5 == model.getNoOfPositionsChanged());
	}

	private RandomNumberSortDto populateDto(int id, String unsortedNumber, String sortedNumber, int positionChanged,
			long timeTaken) {
